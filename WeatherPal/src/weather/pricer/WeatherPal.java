...
public class WeatherPal
{
	public static void main(String[] args)
	{
		...
		String[] name_list = {"北京", "广州", "杭州", "济南", "深圳", "石家庄", "武汉",	"郑州", "上海"};
		...
		*/
		...
		System.out.println("Ã¨Â¯Â·Ã¨Â¾â€œÃ¥â€¦Â¥Ã¤Â½Â Ã§Å¡â€žÃ¥Â§â€œÃ¥ï¿½ï¿½Ã¯Â¼Å¡");

		String city_name = sc.nextLine();

		System.out.println("Ã¨Â¯Â·Ã¨Â¾â€œÃ¥â€¦Â¥Ã¤Â½Â Ã§Å¡â€žÃ¥Â¹Â´Ã©Â¾â€žÃ¯Â¼Å¡");

		int age = sc.nextInt();

		System.out.println("Ã¨Â¯Â·Ã¨Â¾â€œÃ¥â€¦Â¥Ã¤Â½Â Ã§Å¡â€žÃ¥Â·Â¥Ã¨Âµâ€žÃ¯Â¼Å¡");

		float salary = sc.nextFloat();

		System.out.println("Ã¤Â½Â Ã§Å¡â€žÃ¤Â¿Â¡Ã¦ï¿½Â¯Ã¥Â¦â€šÃ¤Â¸â€¹Ã¯Â¼Å¡");

		System.out.println("Ã¥Â§â€œÃ¥ï¿½ï¿½Ã¯Â¼Å¡" + city_name + "\n" + "Ã¥Â¹Â´Ã©Â¾â€žÃ¯Â¼Å¡" + age + "\n" + "Ã¥Â·Â¥Ã¨Âµâ€žÃ¯Â¼Å¡" + salary);
		*/
